...
figura_revolucion::figura_revolucion() {

}

figura_revolucion::figura_revolucion(char* ruta, bool tapa_arriba, bool tapa_abajo,bool inversa) {
    /*Comprobamos si se desean tapas superior e inferior*/
    t_arriba = tapa_arriba;
    t_abajo = tapa_abajo;
    
    /*Leemos de un fichero ply los puntos*/
    std::vector<float> u;
    ply::read_vertices(ruta, u);
    
    /*Si la lectura es inversa,invertimos los puntos de orden*/
    if (inversa){
        invertir(u);
    }
...
void figura_revolucion::rotar(int rot) {
    //Vertices
...
void figura_revolucion::toMatrix(std::vector<float> ver) {
...
void figura_revolucion::calcularNormalesCaras() {
    ...
    for (int i = 0; i < caras.size(); i++) {
        ...
        P.clear(); Q.clear(); N.clear();
    }
}

void figura_revolucion::calcularNormalesVertices() {
...
void figura_revolucion::invertir(std::vector<float> &u){
